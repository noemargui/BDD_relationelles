...
ActiveRecord::Schema.define(version: 2019_01_31_152643) do
  ...
  create_table "diplomas", force: :cascade do |t|
    ...
    t.index ["doctor_id"], name: "index_diplomas_on_doctor_id"
    t.index ["doctors_id"], name: "index_diplomas_on_doctors_id"
    t.index ["specialties_id"], name: "index_diplomas_on_specialties_id"
